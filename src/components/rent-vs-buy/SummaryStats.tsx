...
export const SummaryStats: React.FC<SummaryStatsProps> = ({ result }) => {
  ...
  const stats: StatCardData[] = [
    ...
    },
    {
      ...
      accentColor: netWealthGapAtHorizon > 0 ? 'text-indigo-400' : 'text-emerald-400',
      bgGlow: netWealthGapAtHorizon > 0 ? 'from-indigo-500/10 to-indigo-500/5' : 'from-emerald-500/10 to-emerald-500/5',
    },
    {
